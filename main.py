    ...
    with tf.Session(config=sess_config) as sess:
        ...
        for _ in tqdm(range(1, config.num_steps + 1)):
            ...
            if global_step % config.period == 0:
                ...
                print("train step {} loss is {}".format(global_step,loss))
            if global_step % config.checkpoint == 0:
                ...
                print("dev loss is {} f1_score {} exact_match_score {} metrics_score is {}".format(dev_loss,metrics["f1"],metrics["exact_match"],t_metrics))
