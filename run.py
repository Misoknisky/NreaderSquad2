...
from preprocess.preproces import prepro
from main import train, test
flags = tf.flags
os.environ["TF_CPP_MIN_LOG_LEVEL"] = "3"
home = os.getcwd()
train_file = os.path.join(home, "data", "squad", "dev-v2.0.json")
...
flags.DEFINE_string("mode", "train", "prepro/train/debug/test")
flags.DEFINE_string("model","bidaf","rnet/bidaf")
flags.DEFINE_string("gpu","0","gpu device")
...
flags.DEFINE_integer("test_para_limit", 1000,"Max length for paragraph in test")
...
flags.DEFINE_boolean("pretrained_char",True,"Whether to use pretrained char embedding")
